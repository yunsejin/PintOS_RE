...
static bool sleep_list_order(const struct list_elem *a_, const struct list_elem *b_, void *aux UNUSED);
static bool advanced_scheduling(const struct list_elem *a_, const struct list_elem *b_, void *aux UNUSED);
